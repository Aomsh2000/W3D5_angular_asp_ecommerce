...
Visual Studio Code or your preferred editor
Frontend Setup (Angular)
Clone the Repository: First, clone the project repository:


git clone https://github.com/your-repo/ecommerce-app.git
cd ecommerce-app
Install Angular Dependencies: Install the required npm dependencies for Angular:

npm install
Run the Angular Application: To start the Angular development server, use:


ng serve
After the command is executed, navigate to http://localhost:4200/ in your browser to view the application. Any changes to the code will automatically reload the page.

Backend Setup (ASP.NET Core)
Clone the Repository: If you have not already cloned the backend repository, run:


git clone https://github.com/your-repo/ecommerce-backend.git
cd ecommerce-backend
Restore Dependencies: In the backend project folder, restore the dependencies:

dotnet restore
Run the ASP.NET Core Application: After restoring the dependencies, run the application:
